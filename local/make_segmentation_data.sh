...
ctm=build/output/word.ctm
old_data_dir=build/output
new_data_dir=build/machine

mv $old_data_dir/hyp.txt $old_data_dir/text.orig
mkdir -p $new_data_dir/tmp/
cp -f data/dev/wav.scp $old_data_dir
